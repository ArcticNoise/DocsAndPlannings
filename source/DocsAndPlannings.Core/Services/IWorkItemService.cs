...
public interface IWorkItemService
{
    ...
    Task<WorkItemDto> CreateWorkItemAsync(CreateWorkItemRequest request, int creatorId, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto?> GetWorkItemByIdAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto?> GetWorkItemByKeyAsync(string key, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentNullException">Thrown when request is null</exception>
    Task<IReadOnlyList<WorkItemListItemDto>> SearchWorkItemsAsync(WorkItemSearchRequest request, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto> UpdateWorkItemAsync(int id, UpdateWorkItemRequest request, int userId, CancellationToken cancellationToken = default);
    ...
    Task DeleteWorkItemAsync(int id, int userId, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto> AssignWorkItemAsync(int id, int? assigneeId, int userId, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto> UpdateWorkItemStatusAsync(int id, int statusId, int userId, CancellationToken cancellationToken = default);
    ...
    Task<WorkItemDto> UpdateWorkItemParentAsync(int id, int? parentWorkItemId, int userId, CancellationToken cancellationToken = default);
}
