...
/// <summary>
/// Data transfer object for a board column view with work items
/// </summary>
public sealed record BoardColumnViewDto
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the work items in this column
    /// </summary>
    public required IReadOnlyList<WorkItemCardDto> WorkItems { get; init; }

    /// <summary>
    /// Gets the number of work items in this column
    /// </summary>
